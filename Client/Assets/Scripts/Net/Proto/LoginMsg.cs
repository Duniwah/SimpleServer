...
public class MsgRegister : MsgBase
{
    ...
    [ProtoMember(5)] public RegisterType RegisterType;

    //server to client
    [ProtoMember(6)] public RegisterResult Result;
}
...
public class MsgLogin : MsgBase
{
    ...
    [ProtoMember(2)] public string Account;
    [ProtoMember(3)] public string Password;
    [ProtoMember(4)] public LoginType LoginType;

    //server to client
    [ProtoMember(5)] public LoginResult Result;
